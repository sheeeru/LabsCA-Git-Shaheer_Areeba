...
HD_PWD='C:/Users/Student/Downloads/Habib Uni/CA/LabsCA-Git-Shaheer_Areeba/Lab06/la6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_1bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_1bit.tcl
