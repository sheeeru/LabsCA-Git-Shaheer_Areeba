...
// Lab 8 — Memory System Testbench
//
// Address map (resolved from manual address ranges + AddressDecoder.v):
//   address[9]==0  (0–511)    → DataMemory   use e.g. 32'd4
//   address[9:8]=10 (512–767) → LEDs         use 32'd512
//   address[9:8]=11 (768–1023)→ Switches     use 32'd768
//
// Expected $display output:
//   Test 1: address[9:8]=00  (addr 4   → DataMemory write)
//   Test 2: readData=DEADBEEF (DataMemory read back)
//   Test 3: address[9:8]=10  (addr 512 → LED write)
//           leds=00F3
//   Test 4: readData=0000A55A (Switch read, switches=16'hA55A)
//   Test 5: LED  address[9:8]=10  (expect 10)
//           SW   address[9:8]=11  (expect 11)
